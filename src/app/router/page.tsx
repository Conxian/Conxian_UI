    ...
    <div className="space-y-10 bg-background antialiased min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        <div className="space-y-6">
          <div className="space-y-4 p-6 bg-background antialiased-paper border border-accent/20 rounded-xl">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-background antialiased-paper border border-accent/20 rounded-xl min-h-[400px]">
